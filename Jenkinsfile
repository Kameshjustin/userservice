pipeline {
    ...
    environment {
        REPO_URL = 'https://github.com/projectemern/user-service.git'
    ...
    stages {
        ...
        stage('Run with Docker Compose') {
            steps {
                script {
                    echo 'Starting User Service and dependencies using docker-compose...'
    ...
    post {
        success {
            echo 'User Service deployed successfully via Jenkins!'
        }
        failure {
